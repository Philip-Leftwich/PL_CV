...
\quote{I am a PhD research scientist and lecturer, with experience in
genetics, data science and microbiome community analysis.}
...
\begin{cventries}
    \cventry{Biological Sciences, University of East Anglia}{Lecturer}{Norwich}{2019 - Current}{}\vspace{-4.0mm}
...
\end{cvitems}}
    \cventry{Consultant and content developer}{Benchling}{San Francisco}{2020-present}{\begin{cvitems}
...
\item An Introduction to Population Genomics: covers and introduction to Linux OS, Python and R analysing NGS data and SNP calling
\end{cvitems}}
...
\textbf{Google Scholar metrics: h-index: 10}
...
\section{Data Skills}\label{data-skills}}
